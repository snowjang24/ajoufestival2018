...
class LostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lost" do
    assert_difference('Lost.count') do
      post losts_url, params: { lost: { image: @lost.image, item: @lost.item, number: @lost.number, place: @lost.place } }
    end
  ...
  test "should update lost" do
    patch lost_url(@lost), params: { lost: { image: @lost.image, item: @lost.item, number: @lost.number, place: @lost.place } }
